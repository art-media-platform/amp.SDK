...
/*
Tests that the length of a hexagon is properly computed
...
/*
Tests that the line between two hexagons is properly drawn:
...
/*
Tests that the hexagons that form a rectangle are properly computed
